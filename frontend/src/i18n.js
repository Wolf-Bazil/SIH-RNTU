...
const STRINGS = {
  en: {
    ...
    askAgain: 'Ask a follow-up…', clearChat: 'New chat', you: 'You',
    askError: 'The advisory service did not respond. Please try again.',
  ...
  hi: {
    ...
    askAgain: 'आगे पूछें…', clearChat: 'नई बातचीत', you: 'आप',
    askError: 'सलाह सेवा ने उत्तर नहीं दिया। कृपया पुनः प्रयास करें।',
  ...
  ta: {
    ...
    askAgain: 'மேலும் கேளுங்கள்…', clearChat: 'புதிய உரையாடல்', you: 'நீங்கள்',
    askError: 'ஆலோசனை சேவை பதிலளிக்கவில்லை. மீண்டும் முயற்சிக்கவும்.',
  ...
  bn: {
    ...
    askAgain: 'আরও জিজ্ঞাসা করুন…', clearChat: 'নতুন কথোপকথন', you: 'আপনি',
    askError: 'পরামর্শ সেবা সাড়া দেয়নি। আবার চেষ্টা করুন।',
